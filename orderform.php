...
<body style="background-image: url(image/homebackgrndimg.png);">
						...
						<ul style="float: left;">
							<li style="float: left; padding: 0px 25px 25px 25px;">
								<div class="home-prodlist-img"><a href="'.$category.'/view_product.php?pid='.$id.'">
									...
									<div style="text-align: center; padding: 0 0 6px 0;"> <span style="font-size: 15px;">'.$pName.'</span><br> Price: <span id="amountText">'.$price.'</span> USD <span id="aHiddenText" style="display:none">'.$price.'</span></div>
								</div>
